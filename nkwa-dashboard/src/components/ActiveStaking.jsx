// components/ActiveStaking.jsx
"use client";
import { ArrowDown, ArrowUp, Info, RefreshCw } from "lucide-react";
import { Slider } from "@/components/ui/slider"; // Use Radix or your slider lib
import Image from "next/image";
import Avax from "@/assets/Avax.png"; 

export default function ActiveStaking() {
  return (
    <div className="bg-[#1B1C2E] p-6 rounded-2xl text-white w-full shadow-xl space-y-6">
      {/* Header */}
      <div className="flex justify-between items-start">
        <div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-xl font-bold">Stake Avalance (AVAX)</h2>
        ...
        {/* Investment Period */}
        <div className="bg-[#141420] p-4 rounded-xl w-72">
      ...
      {/* Reward Balance */}
      <div className="text-5xl font-bold text-white tracking-wide">31.<span className="text-gray-300">39686</span></div>
